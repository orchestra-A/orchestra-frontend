    ...
    <div className="min-h-screen w-full flex bg-[#F4F1EB] dark:bg-[#1C2618] text-[#1c1c1a] dark:text-[#F3F7F1] flex-col-reverse lg:flex-row">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 lg:px-24 xl:px-32 relative bg-[#F4F1EB] dark:bg-[#1C2618]">
        ...
        <div className="max-w-[400px] w-full mx-auto py-8 lg:py-0">
          ...
          <h1 className="text-2xl font-bold text-[#1c1c1a] dark:text-[#F3F7F1] mb-6 mt-0" style={{ fontFamily: '"Playfair Display", Georgia, serif' }}>Welcome Back</h1>
          ...
          <form onSubmit={handleLogin} className="space-y-3">
            ...
            <div className="space-y-1.5">
              <label className="text-sm font-medium text-[#4a4a45] dark:text-[#a0a5a0]">Email or Username</label>
              <Input
                value={identifier}
                onChange={(e) => setIdentifier(e.target.value)}
                placeholder="Enter your email or username"
                required
                className="!bg-[#f9f7f3] dark:!bg-[#1c2132] border-[#e8e4dc] dark:border-[#2a3042] !text-[#1c1c1a] dark:!text-[#F3F7F1] placeholder:text-[#8a8a82] dark:placeholder:text-[#6a7082] h-10"
              />
            </div>

            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                <label className="text-sm font-medium text-[#4a4a45] dark:text-[#a0a5a0]">Password</label>
                <Link to="/forgot-password" className="text-sm text-[#6b8f5e] dark:text-[#51DD15] hover:text-[#5a7a4e] dark:hover:text-[#40bf0e] transition-colors">Forgot password?</Link>
              </div>
              <Input
                type="password"
                value={password}
            ...
            <div className="relative my-5">
              <div className="absolute inset-0 flex items-center">
                <div className="w-full border-t border-[#eae6df] dark:border-[#2a3042]"></div>
              </div>
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-[#F4F1EB] dark:bg-[#1C2618] text-[#8a8a82] dark:text-[#9095a0]">Or continue with</span>
              </div>
            </div>

            <div className="grid grid-cols-2 gap-2">
              <a href="https://orchestra-backend-2v5a.onrender.com/auth/google" className="w-full block">
                <Button type="button" variant="outline" className="w-full bg-white dark:bg-[#1c2132] border border-[#eae6df] dark:border-[#2a3042] shadow-sm text-[#4a4a45] dark:text-[#F3F7F1] hover:bg-gray-50 dark:hover:bg-[#252a3a] h-10 cursor-pointer transition-all">
          ...
          <p className="text-center text-[#8a8a82] dark:text-[#9095a0] mt-6 text-sm">
            Don't have an account? <Link to="/signup" className="text-[#6b8f5e] dark:text-[#51DD15] hover:text-[#5a7a4e] dark:hover:text-[#40bf0e] font-medium transition-colors">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
