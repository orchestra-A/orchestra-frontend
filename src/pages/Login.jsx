    ...
    <div className="min-h-screen w-full flex bg-gray-50 text-gray-900 dark:text-white/90 flex-col-reverse lg:flex-row">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 lg:px-24 xl:px-32 relative bg-white">
        ...
        <div className="max-w-md w-full mx-auto py-12 lg:py-0">
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white/90 mb-8">Welcome Back</h1>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <Input 
                ...
                required 
                className="bg-white border-gray-200 text-gray-900 dark:text-white/90 placeholder:text-gray-400 h-11" 
              />
            </div>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-500 dark:text-white/50">Or continue with</span>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <a href="https://web-production-30f40.up.railway.app/auth/github" className="w-full block">
                <Button type="button" className="w-full bg-[#5865F2] hover:bg-[#4752C4] border-transparent shadow-sm text-white h-11 cursor-pointer transition-all">
