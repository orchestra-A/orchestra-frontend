  ...
  return (
    <div className="max-w-4xl mx-auto h-full flex flex-col">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
        <div className="bg-white dark:bg-[#09090B] border border-gray-200 dark:border-[#27272A] rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-shadow cursor-pointer group">
