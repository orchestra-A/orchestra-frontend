    ...
    <div className="max-w-4xl mx-auto h-full flex flex-col">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
        <div className="bg-[#6B905F] dark:bg-[#09090B] border border-gray-200 dark:border-[#27272A] rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-shadow cursor-pointer group">
          ...
          <h3 className="text-lg font-semibold text-white dark:text-white/90 mb-2">Documentation</h3>
        ...
        <div className="bg-[#6B905F] dark:bg-[#09090B] border border-gray-200 dark:border-[#27272A] rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-shadow cursor-pointer group">
          ...
          <h3 className="text-lg font-semibold text-white dark:text-white/90 mb-2">Contact Support</h3>
          <p className="text-white/80 dark:text-white/50 text-sm">Send us an email and we'll get back to you within 24 hours.</p>
        </div>
      </div>
    </div>
  );
