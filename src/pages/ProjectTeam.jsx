  ...
  return (
    <div className="max-w-7xl mx-auto h-full flex flex-col">
      <div className="flex items-center justify-between mb-8">
        ...
        <Button className="bg-[#F4F1EB] dark:bg-[#1A1E2E] text-gray-700 dark:text-white/90 border border-gray-300 dark:border-[#2A3142] hover:bg-[#F3F7F1] dark:hover:bg-[#2A3142] shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {team.map(member => (
          <div key={member.id} className="bg-[#F4F1EB] dark:bg-[#1A1E2E] border border-gray-200 dark:border-[#2A3142] rounded-xl p-6 shadow-sm flex items-center gap-4">
