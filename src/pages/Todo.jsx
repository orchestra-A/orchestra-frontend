...
export default function Todo() {
  ...
  return (
    <div className="max-w-[1400px] mx-auto h-full flex flex-col">
      <div className="mb-4">
        <h1 className="text-gray-900 text-lg font-bold mb-1">My Tasks</h1>
        <p className="text-gray-500 text-sm">Track and manage your daily to-dos.</p>
      </div>

      <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-6 overflow-hidden pb-6">
        {/* Column 1: Behind/Delayed/Stopped */}
        <div className="flex flex-col bg-gray-50/50 rounded-xl border-2 border-gray-200 overflow-hidden shadow-inner">
          <div className="p-3 border-b-2 border-gray-200 bg-gray-100 flex items-center gap-2 sticky top-0">
            <AlertCircle className="w-4 h-4 text-red-600" />
            <h2 className="font-bold text-gray-700 text-sm">Behind / Delayed / Stopped</h2>
            <span className="ml-auto bg-gray-200 text-gray-700 text-[10px] font-bold px-2 py-0.5 rounded-full">{delayedTasks.length}</span>
          </div>
        ...
        <div className="flex flex-col bg-gray-50/50 rounded-xl border-2 border-gray-200 overflow-hidden shadow-inner">
          <div className="p-3 border-b-2 border-gray-200 bg-gray-100 flex items-center gap-2 sticky top-0">
            ...
            <span className="ml-auto bg-gray-200 text-gray-700 text-[10px] font-bold px-2 py-0.5 rounded-full">{inProgressTasks.length}</span>
          </div>
          <div className="flex-1 overflow-y-auto p-3 space-y-3">
        ...
        <div className="flex flex-col bg-gray-50/50 rounded-xl border-2 border-gray-200 overflow-hidden shadow-inner">
          <div className="p-3 border-b-2 border-gray-200 bg-gray-100 flex items-center gap-2 sticky top-0">
            ...
            <h2 className="font-bold text-gray-700 text-sm">Upcoming</h2>
            <span className="ml-auto bg-gray-200 text-gray-700 text-[10px] font-bold px-2 py-0.5 rounded-full">{upcomingTasks.length}</span>
          </div>
          <div className="flex-1 overflow-y-auto p-3 space-y-3">
